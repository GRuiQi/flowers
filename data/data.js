var postList = [
  {
    ...
    reading: 102,
    detail: "《仁医》讲述的是现代脑外科医生南方仁（大泽隆夫饰）通过穿越时空回到了幕末时期，在救治病人的过程中遇到当时的不同英雄人物，并渐渐地被卷入了激荡的历史大潮之中的故事。仁医算是穿越剧，因而也可以说是我看到的最优秀的穿越剧，因为他不是在古代泡妹、升官发财，而是在利用自己医术拯救别人的同时完成了自身的成长。这部剧融合了历史、医学、科幻、穿越等很多方面内容在里面，故事天马行空的同时又十分具有真实感。\n\n南方仁大夫依靠自己的医术在古代完成一次又一次不可能的手术，拯救了许多濒临死亡的病人。但是当他发现那些被他拯救的病人总会以其它方式死去的时候，他陷入了迷茫，发现在历史的洪流面前自己犹如砂砾……在一次又一次的抉择与反思过程中，南方仁最终成长为一个心怀天下的仁者侠医。\n\n这部剧不仅仅是因为它无时无刻都在给你正能量的东西，还在于它里面的每一个人物都有血有肉，都有自己的成长轨迹，让你觉得你和他们在一起成长。上帝只会给人能挺过去的考验，未来的光明是靠现在的人们用双手创造出来的。这是剧中最经典的一句台词，我在此献给每个在不断努力的人们。也希望这部好剧能给你们带来感动与成长……",
    collection: 92,
    dateTime: "24小时前",
