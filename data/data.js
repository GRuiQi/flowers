var postList = [{
  ...
  },
  {
    ...
    detail: "今野芽衣，17岁，活泼可爱人缘好，享受青春，志愿一辈子在自己热爱的故乡生活。\n今野芽衣，24岁，沉静内敛，在东京的出版社做着派遣职员，却因为和摄影师的不伦恋情，被原配当众打了一耳光后，灰溜溜地辞职。\n回到自己的小公寓，卸妆，将头发绑成丸子头，索然无味地吃着杯面看电视。忽然，手机提示，马上就是染谷航太的生日了。就在同时，电视上的新闻告诉她，故乡的樱花反季节盛开。于是，在离开故乡7年后，她决定回去，看看樱花！回到故乡的芽衣，在樱花反季节盛开的树下遇到了航太...\n\n之所以会对这部Abema的自制剧产生兴趣，纯粹是因为剧名——《只有我还是17岁的世界》。无论是《一公升眼泪》里的亚也，还是《人间・失格》里永远停留在15岁的大场诚，又或是《未闻花名》里的芽衣子，越是青春弱小生命的逝去，越叫人不甘和惋惜。因为即便这个世界不是绝对美好，却也有太多太多值得你去期待去感受的，戛然而止的生命永远叫人遗憾。17岁的芽衣和航太是恋人未满，男孩想水到渠成，女孩想要仪式感，结果确是还来不及说爱你就永别，还来不及表达就终结...\n\n成年后时常自问，也偶尔被问：“你有长成自己期盼的样子吗？”,“18岁的你会怎么看待现在的自己呢？” 青春期时幻想过自己成年后的各种可能，真的长大了才发现，哪怕是想变成曾经瞧不上的那份庸碌平淡，也是那么的艰难。曾自以为必不会浑浑噩噩按部就班的生活，工作。以为就算没有什么激情澎湃，百转千回的经历，至少也不会像那些“无趣”的大人们一般，庸庸碌碌...直到现实将你拍醒！发现自己不是独一无二，承认自己的平凡，是长大后最悲伤的事儿。\n\n前些时候，看过一个视频——《欢迎来到成年人的世界》，也不知道为什么，就看哭了，即便没有相同的经历，作为成年人，也会自然共情。无论是那个在夜晚的公交车上独自吃着生日蛋糕的成年人，还是曾经看过的另一个视频里，晚班电车里吃着包子哭泣的成年人，成年人最能明白成年人的艰难。于是越是成年，越爱看青春片。\n\n青春片是刚接触日剧的时候，最喜欢的类型。那里面有春天的樱花和入学式，夏季的甲子园和花火大会，秋天里加厚外套的制服，还有冬日的被炉，初詣以及入学考试, 经典的日剧跑...",
    collection: 26,
    dateTime: "24小时前",
    headImgSrc: "/images/background/bestplayers.png",
    author: "深白色",
    date: "Nov 20 2016",
    avatar: "/images/avatar/3.png",
    postId: 3,
  ...
  },
  {
    ...
    imgSrc: "/images/background/jumpfly.png",
    reading: 96,
